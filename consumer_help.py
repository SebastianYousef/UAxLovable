...
GLOSSARY: dict[str, tuple[str, str]] = {
    ...
    "floor": ("Holding floor / smallest share worth holding", "The smallest target weight a proposed mix may give a holding. At a 2% floor, a holding is either dropped to 0% or kept at 2% or more, so the plan never asks you to keep a 0.1% sliver that costs more to trade and follow than it can add. Raising the floor drops more holdings and concentrates the mix; your current portfolio and the equal-weight mix are shown as they are."),
...
ALIASES = {
    ...
    "minimum_weight": "floor", "min_weight": "floor", "holdings": "floor",
